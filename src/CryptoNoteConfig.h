...
static_assert(_SPEED_FACTOR <= 8 * sizeof(uint64_t), "Bad EMISSION_SPEED_FACTOR");
...
const char     CRYPTONOTE_NAME[]                             = "LibertyCoin";
...
const int      P2P_DEFAULT_PORT                              = 21001;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 21552;
